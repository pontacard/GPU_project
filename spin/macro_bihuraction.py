...
def FMR_bihuraction(alpha, beta, gamma,ax,B,S0,omega, t,  t_eval,theta,Kx,Ky,Kz,start,stop,sta_B0,end_B0,step_B0):
    ...
    for B0 in B0_eval:
        ...
        duf.history()
        poi = duf.poincore(ax,39900,40001)
        B0_list = [B0] * len(poi)
...
FMR_bihuraction(0.02, 0,0.176335977,1,[Bx,0,Bz],S0,[0,omega,0],t,t_eval,[0,0,0],0,0,0,0,900000,0,25,2)
