...
t = [0, 16000]  # t(時間)が0〜100まで動き、その時のfを求める。
t_eval = np.linspace(*t, 16000001)
mu_0 = 1.2
B0 = 10.5
Bx = 160
omega = 28.65
...
FMR_bihuraction(0.05, 0,0.176335977,1,[Bx,0,0],S0,[0,omega,0],t,t_eval,[0,0,0],0,0,0,0,900000,35.6,35.8,11)
